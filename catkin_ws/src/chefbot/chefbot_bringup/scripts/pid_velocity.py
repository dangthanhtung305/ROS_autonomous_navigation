...
######################################################
    ...
    #####################################################
        ...
        self.ticks_per_meter = rospy.get_param('ticks_meter', 42718)
    ...
    #####################################################
        ...
        # self.error_smooth = self.error_smooth + 0.25*(self.error - self.error_smooth)
        # self.error = self.error_smooth
        
        # self.pre_previous_error = self.previous_error
        # self.previous_error = self.error
        # self.previous_motor = self.motor

        # self.integral = (self.error + self.previous_error)* pid_dt
        # # rospy.loginfo("i = i + (e * dt):  %0.3f = %0.3f + (%0.3f * %0.3f)" % (self.integral, self.integral, self.error, pid_dt))
        # self.derivative = (self.error - 2*self.previous_error + self.pre_previous_error) / pid_dt
        
        # self.motor = self.previous_motor + (self.Kp * self.error) + (self.Ki * self.integral) + (self.Kd * self.derivative)
