...
#######################################################################################################################
		...
		self._pre_left_encoder_value = 0
...
#Subscribers and Publishers
		...
		self._Left_Encoder = rospy.Publisher('state',Int64,queue_size = 10)		
...
#######################################################################################################################
#Speed subscriber
		self._left_motor_speed = rospy.Subscriber('control_effort',Float32,self._Update_Left_Speed)
		...
		if(len(line) > 0):
			...
			try:
				if(lineParts[0] == 'e'):
					...
					self._left_encoder_value = self._left_encoder_value - self._pre_left_encoder_value
					self._pre_left_encoder_value = self._left_encoder_value 
